...
export function SvrnButton({
  ...
  return (
    <Button className={classnames(styles.svrnButton, styles[size], styles[inverse], styles[variant], classNames)} variant={variant} id={id} disabled={disabled} onClick={onClick}>
      {children}
    </Button>
  )
}
